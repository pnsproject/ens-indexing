...
export const events = {
    ...
    NewTTL: new LogEvent<([node: string, ttl: ethers.BigNumber] & {node: string, ttl: ethers.BigNumber})>(
...
export const functions = {
    ...
    ttl: new Func<[node: string], {node: string}, ethers.BigNumber>(
        abi, '0x16a25cbd'
    ),
...
export class Contract extends ContractBase {
    ...
    ttl(node: string): Promise<ethers.BigNumber> {
