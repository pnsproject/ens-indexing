...
export const functions = {
    ...
    transferPeriodEnds: new Func<[], {}, ethers.BigNumber>(
        abi, '0x4ae05da7'
    ),
    ...
    MIGRATION_LOCK_PERIOD: new Func<[], {}, ethers.BigNumber>(
        abi, '0x6b1bd1c5'
    ),
    ...
    acceptRegistrarTransfer: new Func<[label: string, deed: string, _: ethers.BigNumber], {label: string, deed: string}, []>(
        abi, '0xea9e107a'
    ),
...
export class Contract extends ContractBase {
    ...
    transferPeriodEnds(): Promise<ethers.BigNumber> {
    ...
    MIGRATION_LOCK_PERIOD(): Promise<ethers.BigNumber> {
