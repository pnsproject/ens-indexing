...
export const events = {
    ...
    ExpiryExtended: new LogEvent<([node: string, expiry: ethers.BigNumber] & {node: string, expiry: ethers.BigNumber})>(
    ...
    NameWrapped: new LogEvent<([node: string, name: string, owner: string, fuses: number, expiry: ethers.BigNumber] & {node: string, name: string, owner: string, fuses: number, expiry: ethers.BigNumber})>(
...
export const functions = {
    _tokens: new Func<[_: ethers.BigNumber], {}, ethers.BigNumber>(
        abi, '0xed70554d'
    ),
    ...
    extendExpiry: new Func<[parentNode: string, labelhash: string, expiry: ethers.BigNumber], {parentNode: string, labelhash: string, expiry: ethers.BigNumber}, ethers.BigNumber>(
        abi, '0x6e5d6ad2'
    ),
    getData: new Func<[id: ethers.BigNumber], {id: ethers.BigNumber}, ([owner: string, fuses: number, expiry: ethers.BigNumber] & {owner: string, fuses: number, expiry: ethers.BigNumber})>(
        abi, '0x0178fe3f'
    ),
    ...
    onERC721Received: new Func<[to: string, _: string, tokenId: ethers.BigNumber, data: string], {to: string, tokenId: ethers.BigNumber, data: string}, string>(
        abi, '0x150b7a02'
    ),
    owner: new Func<[], {}, string>(
        abi, '0x8da5cb5b'
    ),
    ownerOf: new Func<[id: ethers.BigNumber], {id: ethers.BigNumber}, string>(
        abi, '0x6352211e'
    ),
    recoverFunds: new Func<[_token: string, _to: string, _amount: ethers.BigNumber], {_token: string, _to: string, _amount: ethers.BigNumber}, []>(
        abi, '0x5d3590d5'
    ),
    registerAndWrapETH2LD: new Func<[label: string, wrappedOwner: string, duration: ethers.BigNumber, resolver: string, ownerControlledFuses: number], {label: string, wrappedOwner: string, duration: ethers.BigNumber, resolver: string, ownerControlledFuses: number}, ethers.BigNumber>(
        abi, '0xa4014982'
    ),
    registrar: new Func<[], {}, string>(
        abi, '0x2b20e397'
    ),
    renew: new Func<[tokenId: ethers.BigNumber, duration: ethers.BigNumber], {tokenId: ethers.BigNumber, duration: ethers.BigNumber}, ethers.BigNumber>(
        abi, '0xc475abff'
    ),
    ...
    setChildFuses: new Func<[parentNode: string, labelhash: string, fuses: number, expiry: ethers.BigNumber], {parentNode: string, labelhash: string, fuses: number, expiry: ethers.BigNumber}, []>(
        abi, '0x33c69ea9'
    ),
    ...
    setRecord: new Func<[node: string, owner: string, resolver: string, ttl: ethers.BigNumber], {node: string, owner: string, resolver: string, ttl: ethers.BigNumber}, []>(
        abi, '0xcf408823'
    ),
    setResolver: new Func<[node: string, resolver: string], {node: string, resolver: string}, []>(
        abi, '0x1896f70a'
    ),
    setSubnodeOwner: new Func<[parentNode: string, label: string, owner: string, fuses: number, expiry: ethers.BigNumber], {parentNode: string, label: string, owner: string, fuses: number, expiry: ethers.BigNumber}, string>(
        abi, '0xc658e086'
    ),
    setSubnodeRecord: new Func<[parentNode: string, label: string, owner: string, resolver: string, ttl: ethers.BigNumber, fuses: number, expiry: ethers.BigNumber], {parentNode: string, label: string, owner: string, resolver: string, ttl: ethers.BigNumber, fuses: number, expiry: ethers.BigNumber}, string>(
        abi, '0x24c1af44'
    ),
    setTTL: new Func<[node: string, ttl: ethers.BigNumber], {node: string, ttl: ethers.BigNumber}, []>(
        abi, '0x14ab9038'
    ),
...
export class Contract extends ContractBase {
    ...
    _tokens(arg0: ethers.BigNumber): Promise<ethers.BigNumber> {
    ...
    getData(id: ethers.BigNumber): Promise<([owner: string, fuses: number, expiry: ethers.BigNumber] & {owner: string, fuses: number, expiry: ethers.BigNumber})> {
    ...
    ownerOf(id: ethers.BigNumber): Promise<string> {
