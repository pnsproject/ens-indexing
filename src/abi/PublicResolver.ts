...
export const events = {
    ...
    AddressChanged: new LogEvent<([node: string, coinType: ethers.BigNumber, newAddress: string] & {node: string, coinType: ethers.BigNumber, newAddress: string})>(
        abi, '0x65412581168e88a1e60c6459d7f44ae83ad0832e670826c05a4e2476b57af752'
    ),
    ABIChanged: new LogEvent<([node: string, contentType: ethers.BigNumber] & {node: string, contentType: ethers.BigNumber})>(
        abi, '0xaa121bbeef5f32f5961a2a28966e769023910fc9479059ee3495d4c1a696efe3'
    ),
    VersionChanged: new LogEvent<([node: string, newVersion: ethers.BigNumber] & {node: string, newVersion: ethers.BigNumber})>(
...
export const functions = {
    ...
    ABI: new Func<[node: string, contentTypes: ethers.BigNumber], {node: string, contentTypes: ethers.BigNumber}, [_: ethers.BigNumber, _: string]>(
        abi, '0x2203ab56'
    ),
    ...
    setABI: new Func<[node: string, contentType: ethers.BigNumber, data: string], {node: string, contentType: ethers.BigNumber, data: string}, []>(
        abi, '0x623195b0'
    ),
    ...
    'setAddr(bytes32,uint256,bytes)': new Func<[node: string, coinType: ethers.BigNumber, a: string], {node: string, coinType: ethers.BigNumber, a: string}, []>(
        abi, '0x8b95dd71'
    ),
    ...
    'addr(bytes32,uint256)': new Func<[node: string, coinType: ethers.BigNumber], {node: string, coinType: ethers.BigNumber}, string>(
        abi, '0xf1cb7e06'
    ),
...
export class Contract extends ContractBase {
    ...
    ABI(node: string, contentTypes: ethers.BigNumber): Promise<[_: ethers.BigNumber, _: string]> {
    ...
    'addr(bytes32,uint256)'(node: string, coinType: ethers.BigNumber): Promise<string> {
