...
export const functions = {
    creationDate: new Func<[], {}, ethers.BigNumber>(
        abi, '0x05b34410'
    ),
    ...
    value: new Func<[], {}, ethers.BigNumber>(
        abi, '0x3fa4f245'
    ),
    ...
    setBalance: new Func<[newValue: ethers.BigNumber, throwOnFailure: boolean], {newValue: ethers.BigNumber, throwOnFailure: boolean}, []>(
        abi, '0xb0c80972'
    ),
    closeDeed: new Func<[refundRatio: ethers.BigNumber], {refundRatio: ethers.BigNumber}, []>(
        abi, '0xbbe42771'
    ),
...
export class Contract extends ContractBase {
    ...
    creationDate(): Promise<ethers.BigNumber> {
    ...
    value(): Promise<ethers.BigNumber> {
